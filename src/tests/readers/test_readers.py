...
class TestReaders:
    ...
    def test_dissertation(self, workbook: Any) -> None:
        ...
        :param workbook: Объект тестовой диссертации.
        """
    ...
    def test_journal_article(self, workbook: Any) -> None:
        """
        Тестирование чтения статей из журнала.
        :param workbook: Объект тестовой статьи из журнала.
        """
